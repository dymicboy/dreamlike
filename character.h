...
inline std::vector<character_t> create_characters3()
{
	...
	//characters.push_back(init_character(vec3(+3 * block_size, +0 * block_size, +3 * block_size), 0, 2));
	//characters.push_back(init_character(vec3(+0 * block_size, +0 * block_size, -4 * block_size), 0, 2));
	return characters;
}
